...
> Python client SDK for interacting with the core inference API - part of the [AiPillar](https://github.com/AiPillar) open-source ecosystem.
...
The `sdk` package provides the Python interface for integrating with AiPillar's infrastructure, designed for ease of use in both scripts and production services.
...
```bash
git clone https://github.com/AiPillar/sdk
cd sdk
pip install -e .
```
